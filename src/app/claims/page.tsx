...
export default function ClaimsPage() {
  ...
  return (
    <>
      ...
      <h4 className="ml-0 font-bold">View/Edit Your Claim</h4>
      {(() => {
        if (!isConnected) return <WalletWidget />
      ...
      {/* Display the contract address and warning underneath the form */}
      <div className="bg-yellow-100 p-4 rounded-md text-yellow-800 mt-20">
        <p>
          <strong>
            FLO (Flowers) contract address:
            0x4Ab1BFC688992e7c6C344d0a31C5CBd6FbD86f33
          </strong>
          <br />
          IMPORTANT - ONLY interact with this FLO contract in your wallet. It is
          possible for a hacker to make a token named FLO that is a malicious
          contract, putting your funds at risk.
        </p>
      </div>
    </>
  )
